...
use libc::{c_uint, c_ulong, c_long, c_ushort, c_short, c_uchar, c_schar, c_int};
...
mod tests {
    ...
    //TODO implement the seed function from Rosetta Code
    fn i_seed() {}
    //TODO implement iRandom from Rosetta Code
    fn i_random() {}
    //TODO implement iRandA from Rosetta Code
    fn i_rand_a() {}

    fn vernam_cipher(msg: &[u8]) -> &[u8] {
        let msglen = msg.len();
        //TODO find a way to generate a slice of u8
        let mut v: vec![0; msglen as usize];
        v.map(|v| i_rand_a() ^ v);
        v
    }

    //TODO Create te test based off the Vernam and Ceaser cipher examples in Rosetta code
    //https://rosettacode.org/wiki/The_ISAAC_Cipher#C
    // If all else fails, contact Bob Jenkins for a test case
    #[test]
